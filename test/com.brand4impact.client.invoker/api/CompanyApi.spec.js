...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brand4impactJavascriptClient.CompanyApi();
  });
  ...
  describe('CompanyApi', function() {
    ...
    describe('updateCompanyLegal', function() {
      it('should call updateCompanyLegal successfully', function(done) {
        //uncomment below and update the code to test updateCompanyLegal
        //instance.updateCompanyLegal(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateCompanyTopic', function() {
      it('should call updateCompanyTopic successfully', function(done) {
        //uncomment below and update the code to test updateCompanyTopic
        //instance.updateCompanyTopic(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
