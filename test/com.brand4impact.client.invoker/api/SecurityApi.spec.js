...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brand4impactJavascriptClient.SecurityApi();
  });
  ...
  describe('SecurityApi', function() {
    describe('getJWTToken', function() {
      it('should call getJWTToken successfully', function(done) {
        //uncomment below and update the code to test getJWTToken
        //instance.getJWTToken(function(error) {
