...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brand4impactJavascriptClient.SecurityUser();
  });
  ...
  describe('SecurityUser', function() {
    it('should create an instance of SecurityUser', function() {
      // uncomment below and update the code to test SecurityUser
      //var instance = new Brand4impactJavascriptClient.SecurityUser();
      //expect(instance).to.be.a(Brand4impactJavascriptClient.SecurityUser);
    });
