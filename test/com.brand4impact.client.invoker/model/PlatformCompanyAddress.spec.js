...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brand4impactJavascriptClient.PlatformCompanyAddress();
  });
  ...
  describe('PlatformCompanyAddress', function() {
    it('should create an instance of PlatformCompanyAddress', function() {
      // uncomment below and update the code to test PlatformCompanyAddress
      //var instance = new Brand4impactJavascriptClient.PlatformCompanyAddress();
      //expect(instance).to.be.a(Brand4impactJavascriptClient.PlatformCompanyAddress);
    });
