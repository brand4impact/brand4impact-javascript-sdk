...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brand4impactJavascriptClient.PlatformNgoLegalAddress();
  });
  ...
  describe('PlatformNgoLegalAddress', function() {
    it('should create an instance of PlatformNgoLegalAddress', function() {
      // uncomment below and update the code to test PlatformNgoLegalAddress
      //var instance = new Brand4impactJavascriptClient.PlatformNgoLegalAddress();
      //expect(instance).to.be.a(Brand4impactJavascriptClient.PlatformNgoLegalAddress);
    });
