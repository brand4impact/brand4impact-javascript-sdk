...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brand4impactJavascriptClient.PlatformInvoiceItem();
  });
  ...
  describe('PlatformInvoiceItem', function() {
    it('should create an instance of PlatformInvoiceItem', function() {
      // uncomment below and update the code to test PlatformInvoiceItem
      //var instance = new Brand4impactJavascriptClient.PlatformInvoiceItem();
      //expect(instance).to.be.a(Brand4impactJavascriptClient.PlatformInvoiceItem);
    });
