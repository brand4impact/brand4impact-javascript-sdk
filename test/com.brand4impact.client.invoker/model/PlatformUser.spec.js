...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brand4impactJavascriptClient.PlatformUser();
  });
  ...
  describe('PlatformUser', function() {
    it('should create an instance of PlatformUser', function() {
      // uncomment below and update the code to test PlatformUser
      //var instance = new Brand4impactJavascriptClient.PlatformUser();
      //expect(instance).to.be.a(Brand4impactJavascriptClient.PlatformUser);
    });
