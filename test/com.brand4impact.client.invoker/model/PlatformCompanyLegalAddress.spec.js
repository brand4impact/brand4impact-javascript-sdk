...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brand4impactJavascriptClient.PlatformCompanyLegalAddress();
  });
  ...
  describe('PlatformCompanyLegalAddress', function() {
    it('should create an instance of PlatformCompanyLegalAddress', function() {
      // uncomment below and update the code to test PlatformCompanyLegalAddress
      //var instance = new Brand4impactJavascriptClient.PlatformCompanyLegalAddress();
      //expect(instance).to.be.a(Brand4impactJavascriptClient.PlatformCompanyLegalAddress);
    });
